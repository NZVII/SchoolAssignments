...
# Description:      This program prompts for a word, a 2 digit number, and a
                    symbol to create a strong password. Uses C-strings.
                    Also contains a bug that prevents it from behaving normally.
...
int main (){
    ...
    symbol[1], password[MAX_ARRAY_LENGTH];
...
void readNumber(char (&number)[MAX_ARRAY_LENGTH]){
    char tempVar[MAX_ARRAY_LENGTH] = {0};
    bool isValid = true;
    do{
